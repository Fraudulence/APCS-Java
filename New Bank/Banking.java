...
public class Banking
{
    ...
    public static void main (String[] args)
    {
        ...
        acct3.transfer(59.32,acct2);

        /*The "static" term makes it so the method called
         * isn't calling a specific class, but is shared
         * to all objects and instances
         */
        Account acct4 = Account.openAccount("Whisper", 666);
